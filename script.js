...
buttonAcc.forEach(accordOpen => {
    ...
    function openPri(event) {
        ...
        if (accordOpen.classList.contains('opened')) {
            buttonAcc.forEach(accordOpen => accordOpen.classList.remove('opened'));
            buttonAcc.forEach(accordOpen => accordOpen.nextElementSibling.classList.remove('opened'));
        } else {
            buttonAcc.forEach(accordOpen => accordOpen.classList.remove('opened'));
            buttonAcc.forEach(accordOpen => accordOpen.nextElementSibling.classList.remove('opened'));
...
function butGardens(event) {
    ...
    if (butGlp[1].classList.contains('active') && butGlp[2].classList.contains('active')) {
    } else {
        if (!butGlp[1].classList.contains('active') && !butGlp[2].classList.contains('active')) {
            ...
            if (cardGlp[0].classList.contains('blur') && cardGlp[4].classList.contains('blur')) {
                butGlp[0].classList.toggle('active');
                cardGlp[0].classList.remove('blur');
                cardGlp[4].classList.remove('blur');
                cardGlp[0].classList.toggle('no-blur');
...
function butLawn(event) {
    ...
    if (butGlp[0].classList.contains('active') && butGlp[2].classList.contains('active')) {
    } else {
        if (!butGlp[0].classList.contains('active') && !butGlp[2].classList.contains('active')) {
...
function butPlanting(event) {
    ...
    if (butGlp[0].classList.contains('active') && butGlp[1].classList.contains('active')) {
    } else {
        if (!butGlp[0].classList.contains('active') && !butGlp[1].classList.contains('active')) {
            if (butGlp[1].classList.contains('active')) {
                cGlp.forEach(cardGlp => cardGlp.classList.toggle('blur'));
            ...
            if (cardGlp[1].classList.contains('blur') && cardGlp[3].classList.contains('blur') && cardGlp[5].classList.contains('blur')) {
                butGlp[2].classList.toggle('active');
                cardGlp[1].classList.remove('blur');
                cardGlp[3].classList.remove('blur');
                cardGlp[5].classList.remove('blur');
